...
if(tagData.find('thanksEntry').length) { 
  $('#dbtech_thanks_entries_'+postid).parent().parent().removeClass('empty');
  if ($('#dbtech_thanks_entries_'+postid).parent().parent().hasClass('liked'))
    $('#dbtech_thanks_entries_'+postid).parent().parent().removeClass('liked');
  else
    $('#dbtech_thanks_entries_'+postid).parent().parent().addClass('liked');
}
else { $('#dbtech_thanks_entries_'+postid).parent().parent().removeClass('liked').addClass('empty'); }
if(tagData.find('thanksEntry').length)
